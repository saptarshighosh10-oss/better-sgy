...
### Files changed
- `components/CourseGradebook.tsx` — updated (added dynamic timeline math + custom interactive chart component, updated math to support undated assignments, fixed trailing zero bug for whole numbers)
