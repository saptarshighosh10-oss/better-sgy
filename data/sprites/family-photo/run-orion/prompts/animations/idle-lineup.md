Create one horizontal sprite strip for the 2D game character `orion` in animation `idle-lineup`.
...
Output exactly 8 separate animation frames arranged left-to-right in one single row. Each frame must show the same character: original adult male superhero, much taller and broader than the others. Square jaw, short neat black hair, and a very large thick clean black mustache that is the most distinctive facial feature. Wears a clean white/light-gray full suit with red chest section, red cape hanging from shoulders, red gloves, red boots. Upright authoritarian posture, broad shoulders, completely rigid and commanding presence. No mask..

Style contract: clean 2D cartoon game sprite style, vector-clean edges but raster output, bold outline, flat cel shading, readable full-body poses, no 3D render, no glossy app icon lighting. Additional user style notes: clean 2D comic flat colors, thick black outlines, white and red palette, large impressive red cape, visually the tallest and most imposing figure, no gradients, clear strong silhouette dominated by cape.
Camera/view: front-facing.
Animation action: standing perfectly rigid in a lineup for a family photo, barely moving, cape sways very slightly, arms at sides, upright authoritarian posture, staring directly at camera with intense expression.
