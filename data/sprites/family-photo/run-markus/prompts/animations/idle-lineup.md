Create one horizontal sprite strip for the 2D game character `markus` in animation `idle-lineup`.
...
Animation action: standing in a lineup holding still for a family photo, subtle breathing bob, slight weight shift, looking at camera with mild awkward energy.
